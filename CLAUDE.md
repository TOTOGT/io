...
- [x] (2026-09-24: reserved 10.5281/zenodo.22929142; page, README, CatGT_Main header updated) Reserve the V6 DOI on Zenodo as a NEW VERSION of the same record series (after V5 22851704); then replace "V6 DOI pending" in index.html (masthead meta, footer), README, and the CatGT_Main header comment (io + geometry copies together, comment only).
